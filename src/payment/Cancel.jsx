  ...
  return (
    <div className='grid place-items-center w-full lg:h-screen h-full font-raleway bg-[#F7F7F7]'>
      <div className='max-w-5xl rounded flex flex-col'>
        ...
        <div className='flex bg-red-600 p-20 justify-center rounded-full shadow-2xl items-center mx-auto my-12 w-96'>
        </div>
        <div className='my-10 mx-auto'>
          <Link to="/" className='underline cursor-pointer tex-xl underline-offset-4'>Back to Home</Link>
        </div>
      </div>
    </div>
  )
